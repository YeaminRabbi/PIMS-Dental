                                    ...
                                    @foreach ($appointments as $key=> $data)
                                        @if ($data->status == 1)
                                            <tr >
                                                ...
                                                <td><a href="{{ route('AppointmentView', $data->id) }}" style="color: black;">{{date('h:ia', strtotime($data->appointment_time))}}</a></td>
                                        ...
                                        @else
                                            <tr style="background-color:beige;">
                                                ...
                                                <td><a href="{{ route('AppointmentView', $data->id) }}" style="color: black;font-weight:bold;">{{date('h:ia', strtotime($data->appointment_time))}}</a></td>
